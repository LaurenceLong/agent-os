...
flowchart TB
    ...
    subgraph tools["Built-In Tool Data Plane"]
        builtin_tools["Kernel-owned built-in tools<br/>glob_files, grep_files, read_file, read_image, apply_patch, run_command<br/>ecosystem tools, control-plane tools, submit_final"]
